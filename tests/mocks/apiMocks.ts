...
export const mockActionGather = jest.fn() as jest.MockedFunction<typeof import('../../src/api_calls/Actions.js').actionGather>;
export const mockGetItemInformation = jest.fn() as jest.MockedFunction<typeof import('../../src/api_calls/Items.js').getItemInformation>;
export const mockGetMaps = jest.fn() as jest.MockedFunction<typeof import('../../src/api_calls/Maps.js').getMaps>;
export const mockGetAllMonsterInformation = jest.fn() as jest.MockedFunction<typeof import('../../src/api_calls/Monsters.js').getAllMonsterInformation>;
export const mockGetResourceInformation = jest.fn() as jest.MockedFunction<typeof import('../../src/api_calls/Resources.js').getResourceInformation>;
